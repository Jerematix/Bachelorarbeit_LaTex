...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{itshape}
        ...
        To answer these research questions I developed a spatio-temporal econometric model using a data set of about 700000 datapoints spanning 103 days from different shared mobility providers in the realm of cars, kick scooters and bikes.
        This was combined with the corresponding public transit data from Cologne to calculate the density of the public transit.
        Additional factors as weather, weekday and centrality were considered as well.
        The analysis of the results results shows, a clear connection between public transit schedules and shared mobility, strongest for light rail, then regional trains and last buses.
    ...
    Sustainability concerns are getting much more important in today's times as effects like climate change and pollution are advancing and risk of making the earth an uninhabitable space.
    ...
    To solve these challenges, society has to look at alternative ways of transportations, to move away from car centric transportation.
    ...
    If one wants to travel from point A to point B, they have to wait for public transit to arrive, and thus increase their commute time, without a benefit for themselves.
    ...
    These problems are extensive issues for public transit, and public transit providers, as well as local government have to work on these problems to improve the service level (\cite{Fan2019}, p.1-2).
