...
\title{Bachelor Thesis - Analyzing the Effects of Public Transit Schedules on Shared Mobility Usage}
...
\begin{document}
    ...
    \begin{enumerate}
        \item Lime is only present in the first month, and has a majority share there.
    ...
    I fixed these issues by firstly removing Lime from the dataset, which is very unfortunate, but it will make it easier to compare the other days that way.
