...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    These hypotheses will be introduced in the Method & Hypotheses part.
    ...
    The reason for removing and cleaning all this data is, because the predictive value fo the model goes down significantly, because the comparison between the days is too difficult, and especially when a lot of the data comes from one provider like with lime, it really skews the model.
    ...
    \begin{table}
        ...
        \end{adjustbox}
        \caption{}
        \label{tab:Regression Summary for Bikes and Cars}
    \end{table}
    ...
    \begin{table}
        ...
        \end{adjustbox}
        \caption{}
        \label{tab:Regression Summary for Scooters and Rest}
    \end{table}
