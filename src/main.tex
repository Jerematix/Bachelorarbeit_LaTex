...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    The city centre is chosen as the Cologne main station, which is a really big traffic centre for cologne, and is right next the the Kölner Dom, which is the most well known structure of Cologne .
    It is used to calculate the distance from the start stop event to the city centre, to filter out spatial dynamics.
    ...
    Because of that, a variable about the distance to the city centre in metres is needed, this helps to counteract some of the city centre driven dynamics in the data.
    ...
    \beta_{9} \times distance\_to\_city\_centre + \beta_{10} \times  timebucket\_00\_04 +  \beta_{11} \times  timebucket\_04\_08 +  \beta_{12} \times  timebucket\_08\_12 +
    ...
    \begin{table}[H]
        ...
        \begin{adjustbox}{width=1.2\textwidth,center=\textwidth}
            \begin{tabular}{ll|llll}
                ...
                \midrule
                Average Distance to City Centre (m)      & 05.11.19-14.12.19  & 4418,74        & 3683,67        & 4374,1        & 2334,81                \\
    ...
    The smaller service area of the kick scooters is also clearly visible for if compared to the car, which has roughly double the average distance to city centre.
    The bike also has considerably closer aligned service area when compared to the car, shown by the fact, that the average distance to the city centre is about 700 metres lower compared to car and union.
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{l|llll}
            ...
            num\_city\_train\_trips     & 0,0375***      & 0,0621***     & 0,0851***         & 0,0794***      \\
            num\_regional\_train\_trips & 0,0074***      & 0,0380***     & -0,0047           & 0,0450***      \\
            num\_bus\_trips             & 0,0397***      & 0,0194***     & 0,0168***         & 0,0348***      \\
            num\_routes                 & -0,0153***     & -0,0177***    & 0,0019            & -0,0055***     \\
            is\_weekday                 & -0,0013***     & -0,0069***    & -0,0073***        & -0,0047***     \\
            precip                      & -0,0014***     & 0,0016***     & -0,0030***        & -0,0010***     \\
            sum\_precip\_amount         & -0,0078***     & 0,0040***     & -0,0106***        & -0,0060***     \\
            mean\_temp                  & 0,0058***      & 0,0015*       & 0,0070***         & 0,0039***      \\
            distance\_to\_city\_centre  & -0,0267***     & -0,0544***    & -0,0167***        & -0,0394***     \\
            timebucket\_00\_04          & -0,0047***     & -0,0113***    & -0,0059***        & -0,0060***     \\
            timebucket\_04\_08          & -0,0082***     & -0,0142***    & -0,0119***        & -0,0106***     \\
            timebucket\_08\_12          & -0,0062***     & 0,0036***     & -0,0019           & -0,0035***     \\
            timebucket\_12\_16          & 0,0017***      & 0,0330***     & 0,0169***         & 0,0121***      \\
            timebucket\_16\_20          & 0,0067***      & 0,0455***     & 0,0180***         & 0,0164***      \\
            timebucket\_20\_24          & 0,0039***      & 0,0219***     & 0,0189***         & 0,0099***      \\
            R-squared                   & 0,1108         & 0,2182        & 0,2110            & 0,2892         \\
            R-squared Adj.              & 0,1107         & 0,2182        & 0,2106            & 0,2892         \\
            \bottomrule
        \end{tabular}
        * p<.1, ** p<.05, ***p<.01
    ...
    \begin{table}
        ...
        \begin{adjustbox}{width=1.2\textwidth,center=\textwidth}
            \begin{tabular}{lllllll}
                ...
                num\_city\_train\_trips     & 0,0375***           & 0,0316***          & 0,0315***            & 0,0621***           & 0,0614***          & 0,0583***            \\
                & -0,0008             & -0,0008            & -0,0008              & -0,0012             & -0,0013            & -0,0013              \\
                num\_regional\_train\_trips & 0,0074***           & 0,0057***          & 0,0068***            & 0,0380***           & 0,0401***          & 0,0332***            \\
                & -0,0021             & -0,002             & -0,0022              & -0,0033             & -0,0035            & -0,0034              \\
                num\_bus\_trips             & 0,0397***           & 0,0345***          & 0,0324***            & 0,0194***           & 0,0268***          & 0,0106***            \\
                & -0,0011             & -0,0011            & -0,0012              & -0,0019             & -0,002             & -0,0019              \\
                num\_routes                 & -0,0153***          & -0,0143***         & -0,0114***           & -0,0177***          & -0,0323***         & -0,0019              \\
                & -0,0022             & -0,0021            & -0,0023              & -0,0034             & -0,0036            & -0,0036              \\
                is\_weekday                 & -0,0013***          & -0,0008***         & -0,0014***           & -0,0069***          & -0,0067***         & -0,0067***           \\
                & -0,0002             & -0,0002            & -0,0002              & -0,0003             & -0,0003            & -0,0003              \\
                precip                      & -0,0014***          & -0,0012***         & -0,0011***           & 0,0016***           & 0,0015***          & 0,0016***            \\
                & -0,0002             & -0,0002            & -0,0002              & -0,0003             & -0,0003            & -0,0003              \\
                sum\_precip\_amount         & -0,0078***          & -0,0064***         & -0,0067***           & 0,0040***           & 0,0044***          & 0,0033***            \\
                & -0,0007             & -0,0007            & -0,0007              & -0,0011             & -0,0012            & -0,0012              \\
                mean\_temp                  & 0,0058***           & 0,0047***          & 0,0052***            & 0,0015*             & 0,0018**           & 0,0011               \\
                & -0,0005             & -0,0005            & -0,0005              & -0,0008             & -0,0009            & -0,0009              \\
                distance\_to\_city\_centre  & -0,0267***          & -0,0220***         & -0,0231***           & -0,0544***          & -0,0536*** & -0,0514*** \\
                & -0,0004             & -0,0004            & -0,0004              & -0,0006             & -0,0006            & -0,0006              \\
                timebucket\_00\_04\_x       & -0,0047***          & -0,0046***         & -0,0035***           & -0,0113***          & -0,0112***         & -0,0112***           \\
                & -0,0005             & -0,0005            & -0,0005              & -0,0007             & -0,0008            & -0,0007              \\
                timebucket\_04\_08\_x       & -0,0082***          & -0,0076***         & -0,0064***           & -0,0142***          & -0,0143***         & -0,0137***           \\
                & -0,0005             & -0,0005            & -0,0005              & -0,0007             & -0,0007            & -0,0007              \\
                timebucket\_08\_12\_x       & -0,0062***          & -0,0066***         & -0,0041***           & 0,0036***           & 0,0019***          & 0,0044***            \\
                & -0,0005             & -0,0005            & -0,0005              & -0,0007             & -0,0007            & -0,0007              \\
                timebucket\_12\_16\_x       & 0,0017***           & 0,0002             & 0,0025***            & 0,0330***           & 0,0296***          & 0,0335***            \\
                & -0,0005             & -0,0005            & -0,0005              & -0,0007             & -0,0008            & -0,0008              \\
                timebucket\_16\_20\_x       & 0,0067***           & 0,0049***          & 0,0062***            & 0,0455***           & 0,0456***          & 0,0416***            \\
                & -0,0005             & -0,0005            & -0,0005              & -0,0007             & -0,0008            & -0,0007              \\
                timebucket\_20\_24\_x       & 0,0039***           & 0,0029***          & 0,0034***            & 0,0219***           & 0,0240***          & 0,0177***            \\
                & -0,0005             & -0,0005            & -0,0005              & -0,0007             & -0,0007            & -0,0007              \\
                R-squared                   & 0,1108              & 0,0836             & 0,0782               & 0,2182              & 0,1933             & 0,1879               \\
                R-squared Adj.              & 0,1107              & 0,0836             & 0,0782               & 0,2182              & 0,1933             & 0,1878               \\
                \bottomrule
            \end{tabular}
        \end{adjustbox}
    ...
    \begin{table}
        ...
        \begin{adjustbox}{width=1.2\textwidth,center=\textwidth}
            \begin{tabular}{lllllll}
                ...
                num\_city\_train\_trips     & 0,0851***               & 0,0865***              & 0,0838***                & 0,0794***            & 0,0761***           & 0,0829***             \\
                & -0,0018                 & -0,002                 & -0,0019                  & -0,0007              & -0,0007             & -0,0008               \\
                num\_regional\_train\_trips & -0,0047                 & -0,0007                & -0,0083*                 & 0,0450***            & 0,0432***           & 0,0469***             \\
                & -0,0045                 & -0,0049                & -0,0046                  & -0,0019              & -0,0019             & -0,0021               \\
                num\_bus\_trips             & 0,0168***               & 0,0162***              & 0,0173***                & 0,0348***            & 0,0377***           & 0,0315***             \\
                & -0,0021                 & -0,0023                & -0,0022                  & -0,0011              & -0,0011             & -0,0012               \\
                num\_routes                 & 0,0019                  & -0,0031                & 0,0064                   & -0,0055***           & -0,0131***          & 0,0028                \\
                & -0,0051                 & -0,0056                & -0,0052                  & -0,0019              & -0,002              & -0,0021               \\
                is\_weekday                 & -0,0073***              & -0,0075***             & -0,0071***               & -0,0047***           & -0,0045***          & -0,0049***            \\
                ...
                sum\_precip\_amount         & -0,0106***              & -0,0104***             & -0,0108***               & -0,0060***           & -0,0056***          & -0,0065***            \\
                & -0,0023                 & -0,0025                & -0,0024                  & -0,0006              & -0,0006             & -0,0007               \\
                mean\_temp                  & 0,0070***               & 0,0077***              & 0,0064***                & 0,0039***            & 0,0038***           & 0,0040***             \\
                & -0,0017                 & -0,0019                & -0,0017                  & -0,0005              & -0,0005             & -0,0005               \\
                distance\_to\_city\_centre  & -0,0167***              & -0,0178***             & -0,0157***               & -0,0394***           & -0,0381*** & -0,0409*** \\
                & -0,0012                 & -0,0013                & -0,0012                  & -0,0003              & -0,0003             & -0,0004               \\
                timebucket\_00\_04\_x       & -0,0059***              & -0,0061***             & -0,0060***               & -0,0060***           & -0,0058***          & -0,0065***            \\
                & -0,0015                 & -0,0017                & -0,0016                  & -0,0004              & -0,0004             & -0,0004               \\
                timebucket\_04\_08\_x       & -0,0119***              & -0,0121***             & -0,0121***               & -0,0106***           & -0,0104***          & -0,0112***            \\
                & -0,0014                 & -0,0016                & -0,0015                  & -0,0004              & -0,0004             & -0,0004               \\
                timebucket\_08\_12\_x       & -0,0019                 & -0,0018                & -0,0023                  & -0,0035***           & -0,0040***          & -0,0032***            \\
                & -0,0015                 & -0,0016                & -0,0015                  & -0,0004              & -0,0004             & -0,0004               \\
                timebucket\_12\_16\_x       & 0,0169***               & 0,0179***              & 0,0156***                & 0,0121***            & 0,0108***           & 0,0132***             \\
                & -0,0015                 & -0,0017                & -0,0016                  & -0,0004              & -0,0004             & -0,0005               \\
                timebucket\_16\_20\_x       & 0,0180***               & 0,0197***              & 0,0162***                & 0,0164***            & 0,0163***           & 0,0162***             \\
                & -0,0015                 & -0,0016                & -0,0015                  & -0,0004              & -0,0004             & -0,0004               \\
                timebucket\_20\_24\_x       & 0,0189***               & 0,0202***              & 0,0174***                & 0,0099***            & 0,0103***           & 0,0092***             \\
                & -0,0015                 & -0,0016                & -0,0015                  & -0,0004              & -0,0004             & -0,0004               \\
                R-squared                   & 0,211                   & 0,1905                 & 0,1982                   & 0,2892               & 0,2679              & 0,2687                \\
                R-squared Adj.              & 0,2106                  & 0,1902                 & 0,1979                   & 0,2892               & 0,2678              & 0,2687                \\
                \bottomrule
            \end{tabular}
        \end{adjustbox}
        Standard errors below the coefficients, * p<.1, ** p<.05, ***p<.01
