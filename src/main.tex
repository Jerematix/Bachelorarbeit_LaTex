...
\begin{document}
    ...
    Furthermore weather data is collected from the DWD (\url{https://dwd.de}), because it is an important factor for example mentioned by \cite{Babar2017} and \cite{Oeschger2020}
