...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Another point where the data quality is lacking is the service areas, they
    ...
    The assumptions made in the model are not very well suited to answer these questions at all and it would have needed many more variables to fully explain this effect.
    Thus the $R^2$ value is no focus of the analysis and is only partly used to explain the merit of the models, if it was extremely low, it could be said, that the general variables seem to have a very low impact.
    ...
    Further research with data specifically from call a bike could be helpful, because unfortunately call a bike had to be removed completely due to huge lacks of data for some days.
    ...
    To conclude this thesis, I will quickly recap what I have done and what I have found out.
    I started with
